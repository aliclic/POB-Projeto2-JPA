	...
	private void initialize() {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				label_4.setText("selecionado=" + String.valueOf(table.getValueAt(table.getSelectedRow(), 0)));
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				try{
					if (table.getSelectedRow() >= 0) {	
						...
						label.setText("endereco " + id + " apagado");
						listagem();
	...
	public void listagem() {
		try{
			...
			for(Endereco end : lista) {
				model.addRow(new Object[]{end.getId(), end.getRua(), end.getNumero(), end.getBairro().getNome()} );
			}
