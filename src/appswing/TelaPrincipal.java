...
//	}
	...
	private void initialize() {
		...
		ImageIcon imagem = new ImageIcon(getClass().getResource("../arquivos/agenda-contatos.png"));
		...
		mnBairro = new JMenu("Bairro");
		mnBairro.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				TelaBairro tela = new TelaBairro();
			}
		});
		menuBar.add(mnBairro);

		mnEndereco = new JMenu("Endereco");
		mnEndereco.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
